...
export default function Hero({ toptext, heading, subheading, image }: HeroProps) {
    ...
    return (
        <div className="hero">
            ...
            <div className="hero-signature">
                <svg viewBox="0 -500 2000 2000"   
 style={{ stroke: 'var(--mydark)', strokeWidth: 10 }}>
                    <g transform="translate(0.000000, 200.000000) scale(0.500000,-0.500000)">
                    <path 
                    ref={pathRef}
                    className="hero-signature-path"
                    d="M2376 2538 c-9 -12 -16 -28 -16 -35 0 -9 -15 -13 -44 -13 -53 0 -70
            ...
            <em><p>{subheading}</p></em>
            { image && <img className="hero-image" src={image} alt="Hero visual" />}
        </div>
    );
}